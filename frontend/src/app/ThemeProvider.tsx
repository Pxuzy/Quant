    ...
    <ThemeContext.Provider value={value}>
      <ConfigProvider
        ...
        theme={{
          ...
          token: {
            colorPrimary: mode === 'dark' ? '#2962ff' : '#2962ff',
            colorInfo: mode === 'dark' ? '#2962ff' : '#2962ff',
            colorSuccess: mode === 'dark' ? '#22ab94' : '#22ab94',
            colorWarning: mode === 'dark' ? '#f2b94b' : '#d4941a',
            colorError: mode === 'dark' ? '#f23645' : '#f23645',
            colorBgBase: mode === 'dark' ? '#131722' : '#f5f6f8',
            colorBgContainer: mode === 'dark' ? '#1e222d' : '#ffffff',
            colorBorder: mode === 'dark' ? '#2a2e39' : '#e0e3e8',
            colorTextBase: mode === 'dark' ? '#d1d4dc' : '#131722',
            borderRadius: 4,
            borderRadiusLG: 6,
            borderRadiusSM: 2,
            controlHeight: 34,
          ...
          components: {
            Button: {
              ...
              defaultBg: mode === 'dark' ? '#1e222d' : '#ffffff',
              defaultBorderColor: mode === 'dark' ? '#2a2e39' : '#e0e3e8',
              defaultHoverBg: mode === 'dark' ? '#2a2e39' : '#f0f1f3',
              defaultHoverBorderColor: mode === 'dark' ? '#2962ff' : '#2962ff',
              defaultShadow: 'none',
              fontWeight: 700,
              paddingInline: 14,
              paddingInlineSM: 10,
